...
public:
	...
	UFUNCTION(BlueprintPure, Category = "HSR|Save") bool GetSlotSummary(const FString& SlotName, FHSRSaveSlotSummary& OutSummary) const;
	UFUNCTION(BlueprintCallable, Category = "HSR|Save") void RefreshSlotSummaries();
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "HSR|Save") void OnSaveSlotSummaryChanged(const FHSRSaveSlotSummary& Summary);
